...
export default function Home() {
  ...
  return (
    <div className="rf-public min-h-screen overflow-x-hidden bg-[#e5e8e8] text-slate-950 dark:bg-[#071318] dark:text-white">
      ...
      <main>
        <section className="rf-hero-frame relative mx-4 max-w-[calc(100vw-2rem)] overflow-x-hidden rounded-[2.3rem] border border-white/70 bg-[#0a1113] text-white shadow-[0_30px_90px_-35px_rgba(8,24,31,.7)] sm:mx-6 lg:mx-8">
